...
static func create(_item):
	var scene = load("res://inventory-interaction-system/Inventory/UI/CraftItemPanel.tscn")
...
func reload():
	var scene = load("res://inventory-interaction-system/Inventory/UI/CraftItemRequirement.tscn")
